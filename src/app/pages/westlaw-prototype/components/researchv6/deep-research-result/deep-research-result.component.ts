...
import { PlanTasksComponentv6 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv6 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv6;
