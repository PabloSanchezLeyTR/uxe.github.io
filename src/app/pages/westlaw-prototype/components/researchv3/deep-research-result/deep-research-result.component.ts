...
import { PlanTasksComponentv3 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv3 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv3;
